...
/* Depth-first search (DFS) is an algorithm for traversing on graph data structures.
 * One starts at the root or select some arbitrary node as the root in the case of a graph and explores
...
public static void main(String[] args) {
								...
								// representing graph in matrix form
																...
																while(stack.isEmpty() == false) {
																								...
																								if(nextVertex != null) {
																																...
																																if(node != null) {
																																								...
																																								if(setNewV.getEdgeCount() > 0)
																																																stack.push(node);
																																}
																								}
																}

																System.out.println("DFS traversal is  : "+output);
